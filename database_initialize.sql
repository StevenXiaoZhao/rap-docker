 ...
 * user role table
 */
CREATE TABLE IF NOT EXISTS tb_role_and_user
(
 ...
 *     3 - read&write&manage
 */
CREATE TABLE IF NOT EXISTS tb_project_and_user
(
 ...
 * used for creating multiple to multiple mapping
 */
CREATE TABLE IF NOT EXISTS tb_action_and_page
(
 ...
 */
CREATE TABLE IF NOT EXISTS tb_complex_parameter_list_mapping
(
 ...
 */
CREATE TABLE IF NOT EXISTS tb_request_parameter_list_mapping
(
  action_id    INT(10) NOT NULL,
  parameter_id INT(10) NOT NULL,
 ...
 */
CREATE TABLE IF NOT EXISTS tb_response_parameter_list_mapping
(
  action_id    INT(10) NOT NULL,
  parameter_id INT(10) NOT NULL,
 ...
 */
CREATE TABLE IF NOT EXISTS tb_workspace_save
(
  id           INT(10) AUTO_INCREMENT NOT NULL
    PRIMARY KEY,
 ...
 * 公司表
 */
CREATE TABLE IF NOT EXISTS tb_corporation
(
  id          INT(10) AUTO_INCREMENT NOT NULL
    PRIMARY KEY,
  name        VARCHAR(256)           NOT NULL,
 ...
 * 生产线表
 */
CREATE TABLE IF NOT EXISTS tb_production_line
(
  id             INT(10) AUTO_INCREMENT NOT NULL
    PRIMARY KEY,
  name           VARCHAR(256)           NOT NULL,
...
CREATE TABLE IF NOT EXISTS tb_rule (
    action_id INT(10) NOT NULL PRIMARY KEY,
    rules TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS tb_corporation_and_user
(
  user_id        INT(10) NOT NULL,
  corporation_id INT(10) NOT NULL,
  role_id        INT(10) NOT NULL,
